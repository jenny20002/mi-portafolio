...
function LoginButton() {
  ...
  return (
    <div>
      <BotonMod variant="contained" onClick={handleOpenModal}>Login</BotonMod>

      <Dialog open={modalOpen} onClose={handleCloseModal} maxWidth="xs" fullWidth>
        <DialogTitle sx={{ textAlign: "center", fontWeight: "bold" }}>Iniciar Sesión</DialogTitle>
        <DialogContent>
        ...
        <DialogActions>
          <Stack direction="column" spacing={2} width="100%" px={3} pb={3}>
            ...
            <Button variant="outlined" fullWidth onClick={signInWithFacebook} color="primary">
